...
aparser.add_argument("-alpha1", type=float, help="Parameter transaction fee [percent] in chain_1", default=0.1)
aparser.add_argument("-alpha2", type=float, help="Parameter transaction fee [percent] in chain_2", default=0.1)
aparser.add_argument("-betaA", type=float, help="Parameter deposit by A", default=0.1)
aparser.add_argument("-betaB", type=float, help="Parameter deposit by B", default=0.1)
